...
contract EntryPoint is IEntryPoint, StakeManager {
    ...
    function _validateAccountPrepayment(
        ...
        unchecked {
            ...
            }(op, opInfo.userOpHash, missingAccountFunds) returns (uint256 _validationData) {
    ...
    function _validatePaymasterPrepayment(
        ...
        unchecked {
            ...
            .validatePaymasterUserOp{
                gas: gas
            }(op, opInfo.userOpHash, requiredPreFund) returns (bytes memory _context, uint256 _validationData) {
                context = _context;
                validationData = _validationData;
            } catch Error(string memory revertReason) {
        ...
        returns (uint256 validationData, uint256 paymasterValidationData)
    {
        ...
        uint256 maxGasValues =
            mUserOp.preVerificationGas | mUserOp.verificationGasLimit | mUserOp.callGasLimit | userOp.maxFeePerGas
            ...
            if (paymaster == address(0)) {
                ...
                if (context.length > 0) {
                    ...
                    if (mode != IPaymaster.PostOpMode.postOpReverted) {
                        ...
                        // solhint-disable-next-line no-empty-blocks
                        try IPaymaster(paymaster)
                        .postOp{gas: mUserOp.verificationGasLimit}(mode, context, actualGasCost) {}
