...
contract CallWithExactGasHelper {
    function callWithExactGas(bytes memory payload, address target, uint256 gasLimit, uint16 gasForCallExactCheck)
        public
    ...
    function callWithExactGasSafeReturnData(
        ...
        return CallWithExactGas._callWithExactGasSafeReturnData(
            payload, target, gasLimit, gasForCallExactCheck, maxReturnBytes
        );
    }
    ...
    function callWithExactGasEvenIfTargetIsNoContract(
        ...
        return CallWithExactGas._callWithExactGasEvenIfTargetIsNoContract(
            payload, target, gasLimit, gasForCallExactCheck
        );
    }
}
