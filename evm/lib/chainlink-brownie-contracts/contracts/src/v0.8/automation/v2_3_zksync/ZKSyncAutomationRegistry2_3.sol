...
contract ZKSyncAutomationRegistry2_3 is ZKSyncAutomationRegistryBase2_3, OCR2Abstract, Chainable {
     ...
     */
    constructor(ZKSyncAutomationRegistryLogicA2_3 logicA)
    ...
    function _handleReport(HotVars memory hotVars, Report memory report) private {
        ...
        TransmitVars memory transmitVars =
            TransmitVars({numUpkeepsPassedChecks: 0, totalReimbursement: 0, totalPremium: 0});
        ...
        gasOverhead += 16 * msg.data.length + ACCOUNTING_FIXED_GAS_OVERHEAD
