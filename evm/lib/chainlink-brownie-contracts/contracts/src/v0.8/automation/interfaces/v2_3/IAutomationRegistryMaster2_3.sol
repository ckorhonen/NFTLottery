...
interface IAutomationRegistryMaster2_3 {
    ...
    function setBillingOverrides(uint256 id, AutomationRegistryBase2_3.BillingOverrides memory billingOverrides)
        external;
    ...
    function getBillingConfig(address billingToken)
        external
        view
        returns (AutomationRegistryBase2_3.BillingConfig memory);
    function getBillingOverrides(uint256 upkeepID)
        external
        view
        returns (AutomationRegistryBase2_3.BillingOverrides memory);
