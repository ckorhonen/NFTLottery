...
contract BaseTest is Test {
    ...
    function deployAndConfigureRegistryAndRegistrar(AutoBase.PayoutMode payoutMode)
        internal
    ...
    function _encodeConditionalTrigger(AutoBase.ConditionalTrigger memory trigger)
        internal
        pure
