...
contract BaseTest is Test {
    ...
    function deployAndConfigureZKSyncRegistryAndRegistrar(ZKSyncAutoBase.PayoutMode payoutMode)
        internal
    ...
    function _transmit(uint256[] memory ids, Registry registry, bytes4 selector) internal {
        bytes memory reportBytes;
        {
            ...
            ZKSyncAutoBase.Report memory report = ZKSyncAutoBase.Report(
                uint256(1000000000), uint256(2000000000), upkeepIds, gasLimits, triggers, performDatas
            );
    ...
    function _signReport(bytes memory report, bytes32[3] memory reportContext, uint256[] memory signerPrivateKeys)
        internal
        pure
        returns (bytes32[] memory, bytes32[] memory, bytes32)
    {
    ...
    function _encodeConditionalTrigger(ZKSyncAutoBase.ConditionalTrigger memory trigger)
        internal
        pure
        returns (bytes memory triggerBytes)
    {
