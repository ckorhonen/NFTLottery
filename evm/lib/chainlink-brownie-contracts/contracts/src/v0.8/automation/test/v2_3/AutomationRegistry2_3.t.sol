...
} from "../../../vendor/openzeppelin-solidity/v4.8.3/contracts/token/ERC20/extensions/IERC20Metadata.sol";
...
contract SetConfig is SetUp {
    ...
    function testSetConfigSuccess() public {
        ...
        AutomationRegistryBase2_3.BillingConfig[] memory billingConfigs =
            new AutomationRegistryBase2_3.BillingConfig[](1);
    ...
    function testSetConfigMultipleBillingConfigsSuccess() public {
        ...
        AutomationRegistryBase2_3.BillingConfig[] memory billingConfigs =
            new AutomationRegistryBase2_3.BillingConfig[](2);
        billingConfigs[0] = AutomationRegistryBase2_3.BillingConfig({
            gasFeePPB: 5_001,
    ...
    function testSetConfigTwiceAndLastSetOverwrites() public {
        ...
        AutomationRegistryBase2_3.BillingConfig[] memory billingConfigs1 =
            new AutomationRegistryBase2_3.BillingConfig[](1);
        ...
        AutomationRegistryBase2_3.BillingConfig[] memory billingConfigs2 =
            new AutomationRegistryBase2_3.BillingConfig[](1);
    ...
    function testSetConfigOnTransmittersAndPayees() public {
        ...
        AutomationRegistryBase2_3.TransmitterPayeeInfo[] memory transmitterPayeeInfos =
            registry.getTransmittersWithPayees();
...
contract NOPsSettlement is SetUp {
    ...
    function testSettleNOPsOffchainSuccessWithERC20MultiSteps() public {
        ...
        uint256[] memory payments = new uint256[](TRANSMITTERS.length);
        for (uint256 i = 0; i < TRANSMITTERS.length; i++) {
            (bool active, uint8 index, uint96 balance, uint96 lastCollected,) =
        ...
        require(
            erc20ForPayment2 > erc20ForPayment1, "ERC20AvailableForPayment should be greater after another transmit"
        );
...
contract GetMinBalanceForUpkeep is SetUp {
    function test_accountsForFlatFee_with18Decimals() public {
        // set fee to 0
        AutomationRegistryBase2_3.BillingConfig memory usdTokenConfig =
            registry.getBillingTokenConfig(address(usdToken18));
        ...
        assertEq(
            minBalanceAfter,
            minBalanceBefore
                + ((uint256(usdTokenConfig.flatFeeMilliCents) * 1e13) / 10 ** (18 - usdTokenConfig.decimals))
        );
    }
    ...
    function test_accountsForFlatFee_with6Decimals() public {
        // set fee to 0
        AutomationRegistryBase2_3.BillingConfig memory usdTokenConfig =
            registry.getBillingTokenConfig(address(usdToken6));
        usdTokenConfig.flatFeeMilliCents = 0;
...
contract BillingOverrides is SetUp {
    ...
    function test_Happy_MaxGasPayment_WithBillingOverrides() public {
        ...
        AutomationRegistryBase2_3.BillingOverrides memory billingOverrides = AutomationRegistryBase2_3.BillingOverrides({
            gasFeePPB: DEFAULT_GAS_FEE_PPB * 2, flatFeeMilliCents: DEFAULT_FLAT_FEE_MILLI_CENTS * 2
        });
...
contract Transmit is SetUp {
    ...
    function test_handlesMixedBatchOfBillingTokens() external {
        ...
        require(
            prevUpkeepBalances[2] > registry.getBalance(nativeUpkeepID), "native upkeep balance should have decreased"
        );
...
contract MigrateReceive is SetUp {
    ...
    function test_Success() external {
        ...
        assertEq(
            linkToken.balanceOf(address(registry)), prevTokenBalances[0] - linkToken.balanceOf(address(newRegistry))
        );
        assertEq(
            usdToken18.balanceOf(address(registry)), prevTokenBalances[1] - usdToken18.balanceOf(address(newRegistry))
        );
