...
contract OptimismCrossDomainForwarderTest is L2EPTest {
    ...
    function setUp() public {
        ...
        s_optimismCrossDomainForwarder =
            new OptimismCrossDomainForwarder(s_mockOptimismCrossDomainMessenger, s_l1OwnerAddr);
    ...
    function test_Forward() public {
        ...
        s_mockOptimismCrossDomainMessenger.sendMessage(
            ...
            encodeCrossDomainSetGreetingMsg(
                s_optimismCrossDomainForwarder.forward.selector, address(s_greeter), greeting
            ), // message
            0 // gas limit
        );
