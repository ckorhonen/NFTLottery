...
contract OptimismCrossDomainGovernorTest is L2EPTest {
    ...
    function setUp() public {
        ...
        s_optimismCrossDomainGovernor =
            new OptimismCrossDomainGovernor(s_mockOptimismCrossDomainMessenger, s_l1OwnerAddr);
    ...
    function test_Forward() public {
        ...
        s_mockOptimismCrossDomainMessenger.sendMessage(
            ...
            encodeCrossDomainSetGreetingMsg(
                s_optimismCrossDomainGovernor.forward.selector, address(s_greeter), greeting
            ), // message
            0 // gas limit
        );
    ...
    function test_CallableByCrossDomainMessengerAddressOrL1Owner() public {
        ...
        s_mockOptimismCrossDomainMessenger.sendMessage(
            ...
            encodeCrossDomainMultiSendMsg(
                ...
                address(s_multiSend),
                abi.encodePacked(
                    encodeMultiSendTx(address(s_greeter), "foo"), encodeMultiSendTx(address(s_greeter), "bar")
                )
            ), // message
            0 // gas limit
        );
    ...
    function test_RevertsBatchWhenOneCallFails() public {
        ...
        s_mockOptimismCrossDomainMessenger.sendMessage(
            ...
            encodeCrossDomainMultiSendMsg(
                ...
                address(s_multiSend),
                abi.encodePacked(
                    encodeMultiSendTx(address(s_greeter), "foo"), encodeMultiSendTx(address(s_greeter), "")
                )
            ), // message
            0 // gas limit
        );
