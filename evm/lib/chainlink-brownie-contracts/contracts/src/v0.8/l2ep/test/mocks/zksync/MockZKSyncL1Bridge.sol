...
contract MockBridgehub is IBridgehub {
    ...
    /// Mailbox forwarder
    function proveL2MessageInclusion(uint256, uint256, uint256, L2Message calldata, bytes32[] calldata)
        external
        pure
        override
        returns (bool)
    ...
    function proveL2LogInclusion(uint256, uint256, uint256, L2Log memory, bytes32[] calldata)
        external
        pure
        override
        returns (bool)
    ...
    function proveL1ToL2TransactionStatus(uint256, bytes32, uint256, uint256, uint16, bytes32[] calldata, TxStatus)
        external
        pure
        override
        returns (bool)
    ...
    function requestL2TransactionDirect(L2TransactionRequestDirect calldata txRequest)
        external
        payable
        override
        returns (bytes32)
    ...
    function requestL2TransactionTwoBridges(L2TransactionRequestTwoBridgesOuter calldata)
        external
        payable
        override
        returns (bytes32)
