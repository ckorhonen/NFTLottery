...
contract ExposedVRFCoordinatorV2_5_Optimism is VRFCoordinatorV2_5_Optimism {
    ...
    function calculatePaymentAmountNativeExternal(uint256 startGas, uint256 weiPerUnitGas, bool onlyPremium)
        external
        returns (uint96)
    {
    ...
    function calculatePaymentAmountLinkExternal(uint256 startGas, uint256 weiPerUnitGas, bool onlyPremium)
        external
        returns (uint96, bool)
    {
