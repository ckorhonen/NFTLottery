...
contract VRFOld {
     ...
     */
    function _ecmulVerify(uint256[2] memory multiplicand, uint256 scalar, uint256[2] memory product)
        internal
        pure
    ...
    function _projectiveSub(uint256 x1, uint256 z1, uint256 x2, uint256 z2)
        internal
        pure
    ...
    function _projectiveMul(uint256 x1, uint256 z1, uint256 x2, uint256 z2)
        internal
        pure
        returns (uint256 x3, uint256 z3)
    {
     ...
     *       @return sz
     */
    function _projectiveECAdd(uint256 px, uint256 py, uint256 qx, uint256 qy)
        internal
        pure
    ...
    // point doubling.
    function _affineECAdd(uint256[2] memory p1, uint256[2] memory p2, uint256 invZ)
        internal
        pure
    ...
    function _verifyLinearCombinationWithGenerator(uint256 c, uint256[2] memory p, uint256 s, address lcWitness)
        internal
        pure
        returns (bool)
    {
