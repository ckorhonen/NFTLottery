...
contract VRFV2PlusLoadTestWithMetrics is VRFConsumerBaseV2Plus {
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] calldata _randomWords) internal override {
        ...
        uint256 responseTimeInSeconds =
            s_requests[_requestId].fulfilmentTimestamp - s_requests[_requestId].requestTimestamp;

        (s_slowestResponseTimeInBlocks, s_fastestResponseTimeInBlocks, s_averageResponseTimeInBlocksMillions) = _calculateMetrics(
        ...
        (s_slowestResponseTimeInSeconds, s_fastestResponseTimeInSeconds, s_averageResponseTimeInSecondsMillions) = _calculateMetrics(
