...
contract BaseTest is Test, Constants {
    ...
    function setUp() public virtual {
        ...
        s_nonExistentHashedCapabilityId =
            s_CapabilitiesRegistry.getHashedCapabilityId("non-existent-capability", "1.0.0");
    }
    ...
    function _getNodeOperators() internal pure returns (CapabilitiesRegistry.NodeOperator[] memory) {
        ...
        nodeOperators[0] =
            CapabilitiesRegistry.NodeOperator({admin: NODE_OPERATOR_ONE_ADMIN, name: NODE_OPERATOR_ONE_NAME});
        nodeOperators[1] =
            CapabilitiesRegistry.NodeOperator({admin: NODE_OPERATOR_TWO_ADMIN, name: NODE_OPERATOR_TWO_NAME});
        nodeOperators[2] =
            CapabilitiesRegistry.NodeOperator({admin: NODE_OPERATOR_THREE, name: NODE_OPERATOR_THREE_NAME});
