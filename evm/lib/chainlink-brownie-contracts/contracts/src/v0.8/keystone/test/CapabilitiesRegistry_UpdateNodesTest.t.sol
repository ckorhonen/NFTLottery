...
contract CapabilitiesRegistry_UpdateNodesTest is BaseTest {
    ...
    function test_RevertWhen_EncryptionPublicKeyEmpty() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(CapabilitiesRegistry.InvalidNodeEncryptionPublicKey.selector, bytes32(""))
        );
        s_CapabilitiesRegistry.updateNodes(nodes);
    }
    ...
    function test_RevertWhen_UpdatingNodeWithoutCapabilities() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(CapabilitiesRegistry.InvalidNodeCapabilities.selector, hashedCapabilityIds)
        );
        s_CapabilitiesRegistry.updateNodes(nodes);
    }
