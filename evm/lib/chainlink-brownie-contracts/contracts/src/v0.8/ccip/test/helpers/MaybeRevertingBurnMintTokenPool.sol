...
contract MaybeRevertingBurnMintTokenPool is BurnMintTokenPool {
    ...
    constructor(IBurnMintERC20 token, address[] memory allowlist, address rmnProxy, address router)
        ...
        returns (Pool.LockOrBurnOutV1 memory)
    {
        ...
        return Pool.LockOrBurnOutV1({
            destTokenAddress: getRemoteToken(lockOrBurnIn.remoteChainSelector), destPoolData: s_sourceTokenData
        });
    }
