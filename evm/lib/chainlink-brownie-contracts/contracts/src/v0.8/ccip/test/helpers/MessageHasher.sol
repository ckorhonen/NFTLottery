...
contract MessageHasher {
    ...
    function encodeEVM2AnyTokenAmountsHashPreimage(Internal.EVM2AnyTokenTransfer[] memory tokenAmount)
        public
        pure
        returns (bytes memory)
    {
    ...
    function encodeFinalHashPreimage(
        ...
        return abi.encode(
            leafDomainSeparator, metaDataHash, fixedSizeFieldsHash, senderHash, dataHash, tokenAmountsHash
        );
    }
    ...
    function decodeEVMExtraArgsV2(uint256 gasLimit, bool allowOutOfOrderExecution)
        public
        pure
