...
contract MultiOCR3Base_transmit is MultiOCR3BaseSetup {
    ...
    function test_ConfigDigestMismatch_Revert() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(MultiOCR3Base.ConfigDigestMismatch.selector, s_configDigest1, configDigest)
        );
...
contract MultiOCR3Base_setOCR3Configs is MultiOCR3BaseSetup {
    ...
    function test_Fuzz_SetConfig_Success(MultiOCR3Base.OCRConfigArgs memory ocrConfig, uint64 randomAddressOffset)
        public
    {
    ...
    function test_FTooHigh_Revert() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MultiOCR3Base.InvalidConfig.selector, MultiOCR3Base.InvalidConfigErrorType.F_TOO_HIGH
            )
        );
        s_multiOCR3.setOCR3Configs(ocrConfigs);
    }
    ...
    function test_NoTransmitters_Revert() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MultiOCR3Base.InvalidConfig.selector, MultiOCR3Base.InvalidConfigErrorType.NO_TRANSMITTERS
            )
        );
        s_multiOCR3.setOCR3Configs(ocrConfigs);
    }
